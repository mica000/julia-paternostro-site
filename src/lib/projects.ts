...
const projectsSource: Project[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    year: "2023",
    brief: {
      en: "The Vitória Film Festival reached its 30th edition. The visual identity was developed for that anniversary on one premise: to honour and draw together the different generations who keep the flame of cinema alight. The system organises itself around three ideas: resistance, celebration and evolution. Each translates into graphic elements of its own, such as flames, stars and eyes. The characters hold the centre of the system: of different ages, walking in the same direction, they stand for the passing of a legacy between generations and for cinema's permanent reinvention.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    year: "2025",
    brief: {
      en: "Xou da Xoxa is a self-initiated project made as the final work for the Illustration Direction and Production course at Aprender Design. The brief was to take an existing album and reinterpret it in a language of my own. I chose Xou da Xuxa (1986) and turned it into an acid parody: a comic, darker retelling drawing on the urban legends and conspiracy theories that always surrounded the original, from subliminal messages to demonic pacts and the “X” as an occult symbol. Out of that imagery comes the “Pop Star from Hell”: an androgynous, demonic figure inspired by Xuxa's eighties aesthetic, at once nostalgic and unsettling. It is built entirely from illustration in mixed media: flat-colour vector art with black outlines, digital collage, and a molten, metallic 3D lettering. Flames, halftone textures and a warm palette complete the world, applied across cover, vinyl and t-shirt.",

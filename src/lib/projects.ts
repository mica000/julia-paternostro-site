...
const projectsSource: Project[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    tagline: {
      en: "Brand and visual identity for a music festival in Espírito Santo.",
      pt: "Marca e identidade visual para um festival de música no Espírito Santo.",
    },
    brief: {
      en: "Delírio Tropical is a music festival from Espírito Santo dedicated to highlighting the region’s cultural scene. Its premise is the unexpected encounter: in each performance, two unrelated bands share the stage, and the festival’s concept emerges from that collision of repertoires.\nThe first edition took place in January 2024 on Itapuã Beach, in Vila Velha, bringing together 76 artists in this format.\nThe visual identity was created to give form to this idea. Wild, surreal and retro-futuristic, it combines vibrant colors, halftone textures and bold graphic compositions. At the center of the system is an illustrated character with an animal-like, dreamlike quality, created to capture the mix of sounds, styles and references that defines the festival.",
    ...
    context: {
      en: "As art director, designer and illustrator, I created the festival’s entire visual identity, from the logo and character to the graphic system applied across posters, social media and the event environment. All illustrations were created by me.",
      pt: "Como diretora de arte, designer e ilustradora, criei a identidade visual do festival em sua totalidade, do logotipo à personagem e ao sistema gráfico aplicado a cartazes, redes e ambientação do evento. Todas as ilustrações também são de minha autoria.",
    },
    tileImage: tile(1),
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    deliverables: {
      en: "Creative Direction, Visual Identity and Illustration",
      pt: "Direção Criativa, Identidade Visual e Ilustração",
    },
    title: "Vivs",
    tagline: {
      en: "Visual identity for a brand connecting Brazil and Amsterdam through travel and culture.",
      pt: "Identidade visual para uma marca que conecta Brasil e Amsterdam por meio de turismo e cultura.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2025",
    brief: {
      en: "Vivs connects Brazil and Amsterdam through the perspective of people who live between cultures, bringing travel and art together. The brand unfolds into two sister branches: Vivs Tour, which introduces Amsterdam through a personal and thoughtfully curated lens, and Vivs Backstage, which supports artists and producers moving between the two cultures.\nThe challenge was to create a single identity capable of holding both branches. The solution was to treat them as sister brands: they share the same logo and color palette, differing only in the signature that accompanies each one.\nDrawn by hand, the logo balances rounded forms with sharper cuts, combining warmth and a sense of structure. Illustration leads the system: a curious character moves through the city alongside visual elements that belong partly to the shared Vivs universe and partly to each individual branch. Organic graphics, grainy textures and a vibrant palette complete a young, contemporary identity.",
      pt: "Vivs conecta Brasil e Amsterdam a partir do olhar de quem vive entre culturas, unindo viagem e arte. A marca se desdobra em duas frentes irmãs: a Vivs Tour, que apresenta Amsterdam a partir de uma curadoria afetiva, e a Vivs Backstage, que dá suporte a artistas e produtores em trânsito entre as duas culturas.\nO desafio foi construir uma identidade única capaz de abrigar as duas frentes. A solução foi tratá-las como marcas-irmãs: elas compartilham o mesmo logotipo e a mesma paleta, diferenciando-se apenas pela assinatura de cada uma.\nDesenhado à mão, o logotipo equilibra formas arredondadas e cortes mais precisos, combinando acolhimento e seriedade. A ilustração conduz o sistema: uma personagem curiosa percorre a cidade ao lado de elementos visuais que se dividem entre o universo comum da Vivs e as particularidades de cada frente. Grafismos orgânicos, texturas granuladas e uma paleta vibrante completam uma identidade jovem e contemporânea.",
    },
    context: {
      en: "As art director, I developed the project in its entirety, from research and logo design to the two-brand system and all illustrations.",
    ...
    tileImage: "/Images/Vivs/vivs-01-still.webp",
    gallery: [
      "/Images/Vivs/vivs-01-still.webp",
      "/Images/Vivs/vivs-02.webp",
      "/Images/Vivs/vivs-03-still.webp",
      "/Images/Vivs/vivs-05-still.webp",
      "/Images/Vivs/vivs-06-still.webp",
      "/Images/Vivs/vivs-08.webp",
      "/Images/Vivs/vivs-09.webp",
      "/Images/Vivs/vivs-11.webp",
      "/Images/Vivs/vivs-13.webp",
      "/Images/Vivs/vivs-14.webp",
      "/Images/Vivs/vivs-16.webp",
      "/Images/Vivs/vivs-17.webp",
    ],
    ...
    sections: [
      ...
      { kind: "hero", src: "/Images/Vivs/vivs-02.webp", ratio: "1800/855" },
      { kind: "hero", src: "/Images/Vivs/vivs-03.mp4", ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 2,
        images: ["/Images/Vivs/vivs-04.webp", "/Images/Vivs/vivs-05.mp4"],
        ratio: "1342/1682",
      },
      { kind: "hero", src: "/Images/Vivs/vivs-06.mp4", ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 2,
        images: ["/Images/Vivs/vivs-07.mp4", "/Images/Vivs/vivs-08.webp"],
        ratio: "1342/1682",
      },
      { kind: "hero", src: "/Images/Vivs/vivs-09.webp", ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 2,
        images: ["/Images/Vivs/vivs-10.webp", "/Images/Vivs/vivs-11.webp"],
        ratio: "1342/1682",
      },
      {
        kind: "cols",
        cols: 2,
        images: ["/Images/Vivs/vivs-12.webp", "/Images/Vivs/vivs-13.webp"],
        ratio: "1342/1682",
      },
      { kind: "hero", src: "/Images/Vivs/vivs-14.webp", ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 2,
        images: ["/Images/Vivs/vivs-15.webp", "/Images/Vivs/vivs-16.webp"],
        ratio: "1342/1682",
      },
      { kind: "hero", src: "/Images/Vivs/vivs-17.webp", ratio: "1800/1105" },
    ],
    bg: "#2d7c3b",
  },
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    tagline: {
      en: "Brand and visual identity for a forró festival in Budapest.",
      pt: "Marca e identidade visual para um festival de forró em Budapeste.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2026",
    brief: {
      en: "Budapest Forró Festival is an international forró gathering held on Margaret Island, in the middle of the Danube, bringing together three days of concerts, dancing and workshops.\nCreated for the festival’s first edition, the visual identity connects the Brazilian roots of forró with the landscape of Budapest. The Danube, one of the city’s most defining features, runs through the system alongside the vegetation of Margaret Island and graphic elements inspired by the world of forró, creating a visual language that belongs both to the music and to the place where the festival takes place.\nIn the logotype, two gender-neutral figures dance intertwined, while a custom typeface brings rhythm and movement to the composition. A warm, vibrant palette contrasts with the island’s green tones, and organic shapes extend throughout the identity.",
      pt: "Budapest Forró Festival é um encontro internacional de forró realizado na Ilha Margarida, no meio do rio Danúbio, reunindo três dias de shows, dança e workshops. Criada para a primeira edição do festival, a identidade visual conecta as raízes brasileiras do forró à paisagem de Budapeste. O Danúbio, um dos elementos mais marcantes da cidade, atravessa o sistema junto à vegetação da Ilha Margarida e a elementos gráficos inspirados no universo do forró, criando uma linguagem visual que pertence tanto à música quanto ao lugar onde o festival acontece. No logotipo, duas figuras sem gênero definido dançam entrelaçadas, enquanto uma tipografia customizada traz ritmo e movimento à composição. Uma paleta quente e vibrante contrasta com os tons de verde da ilha, e formas orgânicas se desdobram por toda a identidade.",
    },
    context: {
      en: "I developed the visual identity in its entirety, from research and concept development to the logotype, typography, color palette and graphic elements.",
    ...
    // Same pictures as before the Figma renumbering (476:448): the thumbnail
    // is still the red illustration (was 1, now 6).
    tileImage: asset("budapest-forro", "bff-06"),
    gallery: [
      asset("budapest-forro", "bff-01"),
      asset("budapest-forro", "bff-02"),
      asset("budapest-forro", "bff-06"),
      asset("budapest-forro", "bff-09"),
      asset("budapest-forro", "bff-10"),
      asset("budapest-forro", "bff-11"),
      asset("budapest-forro", "bff-12"),
      asset("budapest-forro", "bff-13"),
    ],
    ...
    // Files are numbered in the order of Julia's Figma layout (node 476:448).
    sections: [
      { kind: "hero", src: asset("budapest-forro", "bff-01"), ratio: "1800/1105" },
      { kind: "hero", src: asset("budapest-forro", "bff-02"), ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 3,
        images: [
          asset("budapest-forro", "bff-03"),
          asset("budapest-forro", "bff-04"),
          asset("budapest-forro", "bff-05"),
        ],
        ratio: "877/1217",
      },
      { kind: "hero", src: asset("budapest-forro", "bff-06"), ratio: "1800/1105" },
      {
        kind: "cols",
        cols: 2,
        images: [asset("budapest-forro", "bff-07", "gif"), asset("budapest-forro", "bff-08")],
        ratio: "1342/1682",
      },
      { kind: "hero", src: asset("budapest-forro", "bff-09"), ratio: "1800/1105" },
      { kind: "hero", src: asset("budapest-forro", "bff-10"), ratio: "1800/1013" },
      { kind: "hero", src: asset("budapest-forro", "bff-11"), ratio: "1800/1013" },
      { kind: "hero", src: asset("budapest-forro", "bff-12"), ratio: "1800/1013" },
      { kind: "hero", src: asset("budapest-forro", "bff-13"), ratio: "1800/1013" },
    ],
    bg: "#c81f3f",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    tagline: {
      en: "Brand and visual identity for the São João edition of Delírio Tropical.",
      pt: "Marca e identidade visual para a edição de São João do Delírio Tropical.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2025",
    brief: {
      en: "Delírio Tropical São João is the festival’s June edition, where forró, São João traditions, and the cultures of Northeast Brazil and Espírito Santo come together in a tropical celebration.\nThe visual identity builds on this mix to create its own imaginary world. Instead of relying on familiar São João symbols, it reinterprets them with humor and a sense of delirium. We also moved away from the usual sunny, daytime imagery associated with the festival and created a nighttime identity that reflects the heat and energy of celebrations that last well into the early hours.\nThe system is entirely illustrated. Flowers, leaves and plants come to life and merge with traditional forró instruments such as accordions, zabumbas and triangles, giving rise to characters like a flower accordion player that brings a touch of magic to the celebration. A hand-drawn lettering logo and a warm, intense color palette complete a universe inspired by the heat of São João nights.",
    ...
    context: {
      en: "As art director, I was responsible for the visual identity, lettering and all illustrations for the project.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    tagline: {
      en: "Visual identity for the 30th Vitória Film Festival.",
      pt: "Identidade visual para o 30º Festival de Cinema de Vitória.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2023",
    brief: {
      en: "The Vitória Film Festival reached its 30th edition. The visual identity was developed to mark the anniversary, with the idea of celebrating and bringing together those who keep the spirit of cinema alive: different generations of people passionate about film.\nThe system is built around three concepts: resistance, celebration and evolution. Each is expressed through its own graphic elements, such as flames, stars and eyes. The characters are at the center of the visual system: different in age, but moving in the same direction, they represent the passing of a legacy from one generation to the next, as well as cinema’s constant reinvention.",
      pt: "O Festival de Cinema de Vitória chegou à sua 30ª edição. A identidade visual foi desenvolvida para o aniversário com a premissa de enaltecer e aproximar os que mantêm a chama do audiovisual acesa: as diferentes gerações de apaixonados por cinema. O sistema se organiza em torno de três conceitos: resistência, celebração e evolução. Cada um deles se traduz em elementos gráficos próprios, como chamas, estrelas e olhos. As personagens ocupam o centro do sistema: de diferentes idades, e caminhando na mesma direção, representam a transmissão de legado entre gerações e a permanente reinvenção do cinema.",
    },
    context: {
      en: "As art director, I was responsible for the visual identity and all illustrations, translating the concept into a cohesive graphic system and set of characters. The creative concept was developed in collaboration with Gabriel Barcellos, who was also responsible for the copywriting.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    title: "Tenda Lab",
    tagline: {
      en: "Brand and visual identity for a Brazilian music festival.",
      pt: "Marca e identidade visual para um festival de música brasileira.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2023",
    brief: {
      en: "Tenda Lab is a festival that celebrates the diversity of Brazilian music, bringing together artists from different generations, styles and musical backgrounds. For its 8th edition, the festival embraced the theme “everyone’s invited,” highlighting plurality as both a creative force and a way of connecting artists and audiences.\nThe visual identity was built around this vibrant, collective spirit. Bright colors, modular shapes and wave-inspired graphics create a dynamic visual universe. A cast of diverse, interchangeable characters brings the “everyone’s invited” concept to life and reinforces the festival’s energetic and inclusive atmosphere.",
    ...
    context: {
      en: "As art director and illustrator, I translated the concept into a graphic system and a set of characters. The creative concept was developed in collaboration with Gabriel Barcellos, who was also responsible for the copywriting.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    year: "2024",
    brief: {
      en: "Leather is a Bitcoin wallet, and this is a series of illustrations made for its product and communication. The set translates web3 concepts such as earning yield on your balance, stablecoins and moving value in a light, human way, so features feel approachable rather than technical.",
      pt: "A Leather é uma carteira de Bitcoin, e esta é uma série de ilustrações criada para seu produto e comunicação. O conjunto traduz conceitos de web3 como render sobre o saldo, stablecoins e movimentação de valor de um jeito leve e humano, deixando as funcionalidades mais acessíveis e menos técnicas.",
    },
    context: {
      en: "Drawn as single-weight white line art on black, each piece leans on everyday metaphors: a coin squeezed like a lime over a cocktail, a savings jar filling with coins, all to make finance feel playful. The restrained, monochrome style keeps the illustrations flexible across the interface, docs and social, adapting to different messages while staying part of one visual family.",
      pt: "Desenhadas como linhas brancas de espessura única sobre fundo preto, cada peça aposta em metáforas do dia a dia: uma moeda espremida como um limão sobre um coquetel, um pote de poupança se enchendo de moedas, tudo para tornar as finanças mais lúdicas. O estilo monocromático e contido mantém as ilustrações flexíveis pela interface, docs e redes, adaptando-se a diferentes mensagens sem perder a unidade visual.",
    },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    title: "A Selva",
    tagline: {
      en: "Brand and visual identity for a multicultural venue in Vitória.",
      pt: "Marca e identidade visual para uma casa multicultural em Vitória.",
    },
    category: { en: "Branding", pt: "Branding" },
    year: "2023",
    brief: {
      en: "A Selva is a multicultural venue in the heart of Vitória, Brazil, hosting concerts, festivals and themed parties with a program centered on Brazilian culture and freedom of expression.\nI was invited to develop its visual identity from scratch, from the logo to a graphic system designed to exist in both physical and digital spaces. Inspired by a night in the forest, the aesthetic explores a world of organic shapes and vibrant colors.\nAt the center of the identity is the jaguar: playful, fierce and irreverent. Created as the face of the venue, it invites the audience to dive into this jungle of freedom. The character was brought to life through a large-scale floor painting, alongside graphic elements applied throughout the walls.\nThe result is an identity that inhabits the venue physically while extending beyond it into its digital presence.",
    ...
    context: {
      en: "As art director, designer and illustrator, I was responsible for the concept, visual identity and illustrations that shaped the venue’s visual universe.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    tagline: {
      en: "Illustration on the bond between human and machine.",
      pt: "Ilustração sobre a relação entre humano e máquina.",
    },
    category: { en: "Illustration", pt: "Ilustração" },
    year: "2025",
    brief: {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    deliverables: {
      en: "Concept, Art Direction & Illustration",
    ...
    year: "2025",
    brief: {
      en: "Xou da Xoxa is a self-initiated project developed as the final assignment for the Illustration Direction and Production course at Aprender Design. The brief was to take an existing album and reinterpret it through a new visual language.\nI chose Xou da Xuxa (1986) and turned it into an acidic parody: a darkly comic reinterpretation inspired by the urban legends and conspiracy theories that have long surrounded the original work, including subliminal messages, demonic pacts and the “X” as an occult symbol.\nFrom this imaginary world emerges the “Pop Star from Hell”: an androgynous, demonic figure inspired by Xuxa’s 1980s aesthetic, designed to evoke nostalgia and unease at the same time.\nThe project was entirely illustrated using mixed techniques: vector illustration with flat colors and black outlines, digital collage, and metallic, melting 3D lettering. Flames, halftone textures and a warm color palette complete the visual universe, applied across an album cover, vinyl and T-shirt.",
    ...
    context: {
      en: "As art director and illustrator, I developed the project in its entirety, from research and concept development to the final illustration, under the guidance of Jun Ioneda.",
      pt: "Como diretora de arte e ilustradora, assinei o projeto integralmente, da pesquisa e defesa conceitual à ilustração final, com orientação de Jun Ioneda.",
    },
    tileImage: asset("xou-da-xoxa", "xoxa-01"),
    ...
    gallery: [
      asset("xou-da-xoxa", "xoxa-01"),
      asset("xou-da-xoxa", "xoxa-02"),
      asset("xou-da-xoxa", "xoxa-03"),
      asset("xou-da-xoxa", "xoxa-04"),
    ],
    // Case-study layout — 5 landscape frames (2740×1682) + 4 tall portraits
    // (1342×1682), interleaved.
    // Files are numbered in the order of Julia's Figma layout (node 476:619):
    // the vinyl, then process (moodboard, reference + sketch, references +
    // lettering, colour study), then the finished piece out in the world.
    sections: [
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-01"), ratio: "2740/1682" },
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-02"), ratio: "2740/1682" },
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-03"), ratio: "2740/1682" },
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-04"), ratio: "2740/1682" },
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-05"), ratio: "2740/1682" },
      { kind: "hero", src: asset("xou-da-xoxa", "xoxa-06"), ratio: "2740/1682" },
      {
        kind: "cols",
        cols: 2,
        images: [asset("xou-da-xoxa", "xoxa-07"), asset("xou-da-xoxa", "xoxa-08")],
        ratio: "1342/1682",
      },
      {
        kind: "cols",
        cols: 2,
        images: [asset("xou-da-xoxa", "xoxa-09"), asset("xou-da-xoxa", "xoxa-10")],
        ratio: "1342/1682",
      },
    ],
    bg: "#e0301e",
